...
import com.ws.auth.domain.enums.Perfil;
import com.ws.auth.domain.enums.Prioridade;
import com.ws.auth.domain.enums.Status;
import com.ws.auth.repositories.ChamadoRepository;
import com.ws.auth.repositories.PessoaRepository;
...
public class DBService {
	...
	public void instanciaDB() {
		...
		Tecnico tec1 = new Tecnico(null, "Fabiano C. Monteiro", "677.138.330-05", "fcm@mail.com", encoder.encode("123"));
